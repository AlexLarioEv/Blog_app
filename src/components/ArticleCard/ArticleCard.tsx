...
const ArticleCard: React.FC<IArticle> = (props) => {
  const { slug, title, description, tagList, favoritesCount, favorited, author, createdAt } = props
    ...
    <li className="artical">
      <div className="artical__content">
        <div className="artical__header">
          ...
          <button className="artical__like" disabled={!authentication.login} onClick={clickLuke}>
